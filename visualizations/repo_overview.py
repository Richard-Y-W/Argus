...
verdicts={1:'Supported',2:'Supported',3:'Partial',4:'Rejected',5:'Rejected',6:'Rejected',7:'Inconclusive',8:'Rejected',9:'Rejected',10:'Rejected',11:'Supported',12:'Supported',13:'Rejected'}
...
ax.set_xlim(.4,13.6);ax.set_ylim(.76,1.17);ax.set_yticks([]);ax.set_xticks([]);ax.spines['left'].set_visible(False);ax.spines['bottom'].set_visible(False);ax.set_title(f'Thirteen preregistered experiments — {summary}');fig.tight_layout();fig.savefig(OUT/'experiment_verdicts.png',bbox_inches='tight');plt.close(fig)
